...
public interface AnnouncementMapper {
    ...
    @Select("""
        ...
        """)
    List<Announcement> findPage(@Param("q") String q, @Param("status") Integer status, @Param("isTop") Boolean isTop, @Param("offset") int offset, @Param("limit") int limit);
    ...
    @Select("""
        ...
        """)
    long countByQuery(@Param("q") String q, @Param("status") Integer status, @Param("isTop") Boolean isTop);
